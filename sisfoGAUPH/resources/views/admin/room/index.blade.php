            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ url('/admin/room') }}" accept-charset="UTF-8"
                                ...
                                <tbody>
                                    @foreach ($room as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->room_id }}</td>
                                            <td>
                                                <a href="{{ url('/admin/room/' . $item->id) }}" title="View room"><button
                                                        class="btn btn-info btn-sm"><i class="fa fa-eye"
                                                            aria-hidden="true"></i> View</button></a>
                                                <a href="{{ url('/admin/room/' . $item->id . '/edit') }}"
                                                    title="Edit room"><button class="btn btn-primary btn-sm"><i
                                                            class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                        Edit</button></a>

                                                <form method="POST" action="{{ url('/admin/room' . '/' . $item->id) }}"
