            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ url('/admin/location') }}" accept-charset="UTF-8"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('/admin/location/' . $item->id) }}"
                                                    title="View location"><button class="btn btn-info btn-sm"><i
                                                            class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                                <a href="{{ url('/admin/location/' . $item->id . '/edit') }}"
                                                    title="Edit location"><button class="btn btn-primary btn-sm"><i
